    ...
    return Drawer(
      ...
      child: Column(
        children: [
          ...
          buildTile(icon: Icons.home, title: 'Inicio', route: '/'),
          buildTile(icon: Icons.meeting_room, title: 'Salones', route: '/classrooms'),
          buildTile(icon: Icons.group_work, title: 'Espacios Compartidos', route: '/shared-spaces'),
          buildTile(icon: Icons.event, title: 'Reuniones', route: '/meetings'),
